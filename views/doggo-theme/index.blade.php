            ...
            <div class="row no-gutters">
                ...
                <div class="col-6 px-5" >
                    <ul class="list-group list-group-flush">
                        <li class="list-group-item bg-transparent"><a class="text-light" href='/garbage-cms/doggo/article'>Article 1</a></li>
                        <li class="list-group-item bg-transparent"><a class="text-light" href='/garbage-cms/doggo/article'>Article 2</a></li>
                        <li class="list-group-item bg-transparent"><a class="text-light" href='/garbage-cms/doggo/article'>Article 3</a></li>
                        <li class="list-group-item bg-transparent"><a class="text-light" href='/garbage-cms/doggo/article'>Article 4</a></li>
                        <li class="list-group-item bg-transparent"><a class="text-light" href='/garbage-cms/doggo/article'>Article 5</a></li>
                    </ul>
                </div>
            </div>
            ...
            <li class="list-group-item border-top-0 border-left-0 border-right-0 mb-3">
                ...
                <div class="row">
                    ...
                    <div class="col-md-7 text-md-left ml-3 mt-3">
                        ...
                        <h6 class="h6 pb-1"><i class="fas fa-desktop pr-1"></i>News Tag/Category</h6>
                        </a>

                        <h4 class="h4 mb-4">News Title</h4>

                        <p class="font-weight-normal">Lorem ipsum, dolor sit amet consectetur adipisicing elit. 
                        Temporibus ad impedit assumenda quas atque aspernatur nihil libero autem unde dolore!</p>
